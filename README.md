...
2. leitet alles unter `/widerstand/*`, `/wizard/*`, `/bluff/*`, `/tempel/*` bzw. `/poker/*` an den jeweiligen Container weiter (inkl. WebSocket-Upgrade für Socket.IO),
...
Widerstand, Wizard, Bluff, Tempel des Schreckens und Poker müssen als eigene Container bereits laufen (`127.0.0.1:8092`, `8093`, `8095`, `8096` bzw. `8097`), bevor der Hub gestartet wird - er leitet nur weiter, hostet die Spiele nicht selbst.
